...
Move findMove(size_t iter) {
    ...
    memset(&best_tabu_move,0, sizeof(best_tabu_move));
...
void TabuSearch() {
    ...
    while (1) {
        ...
        if (cnt == 20000000 || Best_f == 0) break;
    }
...
int main() {
    ...
    while (K--) {
        ...
        cout << "K: " << K << " Best_f: " << Best_f << endl;
        fout << "K: " << K << " Best_f: " << Best_f << endl;
    }

    cout << "K: " << K << " f: " << Best_f << endl;
